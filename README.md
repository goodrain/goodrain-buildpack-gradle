...
3. If you are not using Spring Boot or Ratpack, then follow the instructions for [configuring your build](https://devcenter.heroku.com/articles/deploying-gradle-apps-on-heroku) or follow step 4 and 5.
4. Add a task named `stage` to the root Gradle project that builds your application (this task will be executed to build the app).
5. Add a [Procfile](https://devcenter.heroku.com/articles/procfile) to your project defining how to launch the app.
